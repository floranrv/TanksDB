...
ALTER TABLE fuel_id_seq OWNER TO postgres;
...
--
-- Name: fuel_to_engine_connection_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE fuel_to_engine_connection_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE fuel_to_engine_connection_id_seq OWNER TO postgres;

--
-- Name: fuel_to_engine_connection_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE fuel_to_engine_connection_id_seq OWNED BY fuel_to_engine.connection_id;
...
--
-- Name: governments_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE governments_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE governments_id_seq OWNER TO postgres;

--
-- Name: governments_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE governments_id_seq OWNED BY governments.id;
...
--
-- Name: tank_classes_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE tank_classes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE tank_classes_id_seq OWNER TO postgres;

--
-- Name: tank_classes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE tank_classes_id_seq OWNED BY tank_classes.id;
...
ALTER TABLE tanks_id_seq OWNER TO postgres;
...
--
-- Name: fuel_to_engine connection_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY fuel_to_engine ALTER COLUMN connection_id SET DEFAULT nextval('fuel_to_engine_connection_id_seq'::regclass);


--
-- Name: governments id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY governments ALTER COLUMN id SET DEFAULT nextval('governments_id_seq'::regclass);


--
-- Name: tank_classes id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY tank_classes ALTER COLUMN id SET DEFAULT nextval('tank_classes_id_seq'::regclass);
...
SELECT pg_catalog.setval('engines_id_seq', 1, false);
...
SELECT pg_catalog.setval('fuel_id_seq', 1, false);
...
--
-- Name: fuel_to_engine_connection_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('fuel_to_engine_connection_id_seq', 1, false);
...
--
-- Name: governments_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('governments_id_seq', 1, false);
...
--
-- Name: tank_classes_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('tank_classes_id_seq', 1, false);
...
SELECT pg_catalog.setval('tanks_id_seq', 1, false);
